...
'Program:            Banking
'File:               ClsAccount_EventArgs_AccountModified.vb
'Author:             Nayonika Roy
'Description:        User Interface for the Banking project.
'Date:               
'                    2016 Nov 14
'                      - created the Event Args class for modifying accounts
'                      
'                       
'Tier:               User Interface.
...
Public Class Account_EventArgs_AccountModified
...
End Class 'Account_EventArgs_AccountModified
